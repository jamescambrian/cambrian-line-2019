...
-->
        <li><a href="https://twitter.com/intent/tweet?text=<?php the_title() ?> via @cambrian_line <?php the_permalink() ?>" class="popup">
...
<div class="six columns"><p>Tagged:</p>
      <?php echo get_the_tag_list('<p class="post__tags">',' , ','</p>');?></div>